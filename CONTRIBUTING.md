# Contributing to COLSA

This outlines how to propose a change to COLSA. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("CollaborativeInference/COLSA", fork = TRUE)`.
...
Please note that the COLSA project is released with a [Contributor Code
of Conduct](http://gongziyang.com/COLSA/CODE_OF_CONDUCT.md). By
